  ...
  return (
    <div className="fixed right-4 top-1/2 -translate-y-1/2 z-50 flex flex-col gap-2">
      ...
      <Button
        ...
        onClick={() => window.open('https://line.me/ti/p/@928ibhsy', '_blank')}
      >
      ...
      <Button
        ...
        onClick={() => window.open('tel:02-8231-6869', '_self')}
      >
      ...
      <Button
        ...
        onClick={() => window.open('https://facebook.com/JIETRUECLINIC', '_blank')}
      >
